...
import { PlaylistModel, TrackModel, AddItemsToPlaylistResponse } from './models';
...
export type Track = {
  ...
  /** The track duration in readable format. */
  durationReadable: Scalars['String']['output'];
...
export type ResolversTypes = {
  ...
  AddItemsToPlaylistResponse: ResolverTypeWrapper<AddItemsToPlaylistResponse>;
...
export type ResolversParentTypes = {
  AddItemsToPlaylistInput: AddItemsToPlaylistInput;
  AddItemsToPlaylistResponse: AddItemsToPlaylistResponse;
...
export type TrackResolvers<ContextType = DataSourceContext, ParentType extends ResolversParentTypes['Track'] = ResolversParentTypes['Track']> = {
  ...
  durationReadable?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
